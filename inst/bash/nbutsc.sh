#!/bin/bash
#' ---
#' title: Create Bash Script With Utilities
#' date:  2021-03-11 07:19:58
...
#'
#' ## Description
#' Wrapper script to create a new bash script using utilities functions
#'
#' ## Details
#' The utility functions are all collected in a utilities file which is sourced from the script
#'
#' ## Example
#' nbutsc.sh -o <new_bash_script>
#'
#' ## Set Directives
...
if test "$OUTPUTPATH" == ""; then
  usage "-o <new_script> not defined"
fi
...
$QBASHPATH/create/new_bash_script.sh -t $QBASHPATH/template/bash/bash_script_ut.template -o $OUTPUTPATH $ADDPARAM
